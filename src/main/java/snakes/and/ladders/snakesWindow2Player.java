 ...
 */
public class snakesWindow2Player extends javax.swing.JFrame {
     ...
     */
    boolean playerChoice = false; //controls who's turn it is
    ...
    public void winner(String playerName) {
        ...
        //sets the current amount of wins to increment your previous score by 1 if the winner is not the computer and the player who won was player 1
        if (!playerName.equals("The computer") && playerName.equals("Player 1")) {
            try {
    ...
    public void diceHandler(int diceroll) {
        ...
        playerScoreText.setText(Integer.toString(score)); //Sets player 1's score to the text field
            ...
            //plays victorious music when the player wins
            playerwins++;
    ...
    public void diceHandler2(int diceroll) {
        //Value rolled from dice is added to the score variable
        compscore += diceroll;
        status1.setText("<html>Computer landed on " + compscore + ".<html/>");
    ...
    private void initComponents() {
        ...
        exitButton.setBounds(440, 730, 75, 32);

        diceButton.setText("Roll Die");
        ...
        diceLabel1.setText("Player 2 Rolled a:");
        ...
        diceLabel.setText("Player 1 Rolled a:");
        background.add(diceLabel);
        diceLabel.setBounds(80, 330, 140, 40);
        ...
        restartButton.setBounds(320, 730, 100, 32);

        playerwinLabel.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        playerwinLabel.setText("Player 1 Wins:");
        background.add(playerwinLabel);
        playerwinLabel.setBounds(50, 90, 90, 22);

        compWinsLabel.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        compWinsLabel.setText("Player 2 Wins:");
        compWinsLabel.setToolTipText("");
        background.add(compWinsLabel);
        compWinsLabel.setBounds(50, 150, 110, 22);
        ...
        player1HighscoreLabel.setBounds(320, 770, 120, 30);
        background.add(player1HighscoreText);
        player1HighscoreText.setBounds(460, 770, 50, 24);

        player2HighscoreLabel.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        player2HighscoreLabel.setText("Player 2 Highscore:");
        background.add(player2HighscoreLabel);
        player2HighscoreLabel.setBounds(320, 810, 130, 22);
        background.add(player2HighscoreText);
        player2HighscoreText.setBounds(459, 810, 50, 24);
    ...
    private void diceButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_diceButton2ActionPerformed
        //Restart button is deactivated so the player must play through round
        restartButton.setEnabled(false);
        //Transfers to dice method
        playerChoice = true;
        ...
        diceButton.setEnabled(true);
        player2highscore++;
    }//GEN-LAST:event_diceButton2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(snakesWindow2Player.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new snakesWindow2Player().setVisible(true);
            }
        });
    }
